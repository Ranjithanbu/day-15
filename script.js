...
tdvalue+="<tr>"
tdvalue+=`<td>${Object.values(data[j])[0]}</td><td>${Object.values(data[j])[1]}</td><td>${Object.values(data[j])[2]}</td>`
tdvalue+="</tr>"   
}
tbody.innerHTML=tdvalue
...
console.log(index)
if(index==1){
  PageNumber.innerText="first"
}
else if(index==10){
  PageNumber.innerText="last" 
}
else{PageNumber.innerText=index}

PageNumber.setAttribute("href","#")
PageNumber.setAttribute("index",index)

document.querySelector(".pageNumbers").appendChild(PageNumber)
